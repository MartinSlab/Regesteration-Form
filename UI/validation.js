document.addEventListener('DOMContentLoaded', function () {
    ...
    const inputs = {
        ...
        terms: {id: 'terms', name: 'terms', validation: 'checkbox', displayName: 'أوافق علي حضور الحفل يوم 12 سبتمبر بنادي الحوار' }
    };
        ...
        switch (field.validation) {
            ...
            case 'checkbox':
                ...
                if (!termsCheckbox.checked) {
                    setError(termsCheckbox, 'يجب الموافقة على حضور الحفل');
                    isValid = false;
                } else {
